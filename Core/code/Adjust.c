...
//^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
	CScalerSetByte(_CB_ACCESS_PORT_64, 0x83);
	CScalerSetByte(_CB_DATA_PORT_65, 0x8e);//hong 

		CScalerSetByte(_CB_ACCESS_PORT_64, 0x84);
	CScalerSetByte(_CB_DATA_PORT_65, 0x85);//greed		  Contrast

		CScalerSetByte(_CB_ACCESS_PORT_64, 0x85);
	CScalerSetByte(_CB_DATA_PORT_65, 0x85);//blu
//^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
/*		CScalerSetByte(_CB_ACCESS_PORT_64, 0x86);
	CScalerSetByte(_CB_DATA_PORT_65, 0);//hong 

		CScalerSetByte(_CB_ACCESS_PORT_64, 0x87);
	CScalerSetByte(_CB_DATA_PORT_65, 0);//greed	      bright

		CScalerSetByte(_CB_ACCESS_PORT_64, 0x88);
	CScalerSetByte(_CB_DATA_PORT_65, 0);//blu
//^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
		CScalerSetByte(_CB_ACCESS_PORT_64, 0x89);
	CScalerSetByte(_CB_DATA_PORT_65, 0x80);//hong 

		CScalerSetByte(_CB_ACCESS_PORT_64, 0x8a);
	CScalerSetByte(_CB_DATA_PORT_65, 0x80);//greed		   Contrast

		CScalerSetByte(_CB_ACCESS_PORT_64, 0x8b);
	CScalerSetByte(_CB_DATA_PORT_65, 0x80);//blu*/
//^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
	CScalerSetByte(_CB_ACCESS_PORT_64, 0x00);
