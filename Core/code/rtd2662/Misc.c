...
//Gary for Interior HDMI  DDC 	20070711
	...
	MCU_HDMI_DDC_ENA_FF2C = 0x03;  //disable HDMI DDC channel
    MCU_DDCRAM_PART_FF21  = 0x2b;  //0x2f//addcram_st=2(0xfd00),dddcram_st=20(0xfd80),hddcram_st=3 
	...
	MCU_DDCRAM_PART_FF21  = 0x2f;  //DVI:0x3a//HDMI2:0x2f//addcram_st=3(0xFd80),dddcram_st=2(0xfd80),hddcram_st=2(0xfe00) 
