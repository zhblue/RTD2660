...
#else
    CScalerPageSelect(_PAGEB);
    CScalerSetByte(0xd0, 0x11);
    CScalerSetByte(0xd2, 0x88);
    CScalerSetByte(0xd5, 0x06);
    CScalerSetByte(0xd6, 0x40);
    CScalerSetByte(0xd7, 0x00);
    CScalerSetByte(0xd8, 0x20);
    CScalerSetByte(0xd9, 0x00);
    CScalerSetByte(0xd3, 0x9E);
    CScalerSetByte(0xd4, 0x08);
#endif
}
#endif
