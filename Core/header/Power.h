...
#define ALDD_UP()               (bALDD= _ALDD_ON)
#define ALDD_DOWN()             (bALDD= _ALDD_OFF)
...
//ÉèÖÃ·´Ïà
#if 1
#define LIGHTPOWER_UP()               (bLIGHTPOWER  = _LIGHT_OFF)//(bLIGHTPOWER  = _LIGHT_ON)
#define LIGHTPOWER_DOWN()             (bLIGHTPOWER  = _LIGHT_ON)//(bLIGHTPOWER  = _LIGHT_OFF)
#else
