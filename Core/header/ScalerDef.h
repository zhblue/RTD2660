...
// Display Format(Port)
//--------------------------------------------------
#define _VDISP_CTRL_28                      	0x28        // Video Display Control Register视频显示控制寄存器
#define _VDISP_SIGINV_29                    	0x29        // Display Control Signal Inverted Register控制信号倒像
#define _DISP_ACCESS_PORT_2A              		0x2A        // Display Format Access Port//显示格式
#define _DISP_DATA_PORT_2B                  	0x2B        // Display Format Data Port显示数据端口
#if(_SCALER_TYPE == _RTD3580D)
