...
{
    4,  _NON_AUTOINC,   _IRQ_CTRL0_04,                  0x00,//关闭红外时钟和中断
    4,  _NON_AUTOINC,   _HDMI_STATUS0_05,               0x80,//CRC校验清除
...
#if(_M2PLL_USE == _ON)
    4,  _NON_AUTOINC,   _P1_MULTIPLY_PLL_CTRL0_E0,      0xe0,//色彩浓度设定
#else
